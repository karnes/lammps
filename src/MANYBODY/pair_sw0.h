...
This is a requirement to use the SW0 potential.

E: Pair style Stillinger-Weber requires newton pair on

See the newton command.  This is a restriction to use the SW0
potential.
...
The specified SW0 potential file cannot be opened.  Check that the path
