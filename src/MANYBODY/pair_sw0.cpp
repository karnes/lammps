...
PairSW0::PairSW0(LAMMPS *lmp) : Pair(lmp)
{
  single_enable = 0;
  restartinfo = 0;
  one_coeff = 1;
...
void PairSW0::settings(int narg, char **/*arg*/)
{
...
void PairSW0::coeff(int narg, char **arg)
{
  int i,j,n;
...
double PairSW0::init_one(int i, int j)
{
...
void PairSW0::read_file(char *file)
{
  memory->sfree(params);
  params = nullptr;
  nparams = maxparam = 0;
...
void PairSW0::twobody(Param *param, double rsq, double &fforce,
...
void PairSW0::threebody(Param *paramij, Param *paramik, Param *paramijk,
